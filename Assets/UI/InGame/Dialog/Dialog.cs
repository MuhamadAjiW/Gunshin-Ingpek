...
public partial class Dialog : VisualElement
{
    ...
    VisualElement m_Area;
    VisualElement m_PersonArea;
    VisualElement m_PersonLImage;
    VisualElement m_PersonLLabelContainer;
    Label m_PersonLLabelText;
    VisualElement m_PersonGap;
    VisualElement m_PersonRImage;
    VisualElement m_PersonRLabelContainer;
    Label m_PersonRLabelText;
    VisualElement m_MainTextContainer;
    Label m_MainText;
    ...
    [SerializeField, DontCreateProperty] float attr_TextSpeed;
